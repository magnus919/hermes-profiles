...
At L1, C4 Context diagrams and arc42 quality trees frame the problem space without overwhelming detail — the system boundary and the constraint envelope.

At L2, all three converge: C4 Container and Component diagrams decompose service boundaries, ADRs attach to explain structural rationale, and arc42 sections layer in cross-cutting concerns (performance, security, deployment topology).

At L3, the picture sharpens to implementation depth: C4 Code diagrams for class-and-interface detail, implementation-level ADRs for protocol choices, and arc42 risk/deployment sections for real-world constraints.

Each dimension is independently consumable — an agent needing only structural zoom reads C4 layers without touching a single ADR.
...
| Methodology | Artifact | Pyramid path |
|---|---|---|
| C4 | System Context diagram | 02-analysis/structural-views/system-context.md |
| C4 | Container diagram | 02-analysis/structural-views/container.md |
| C4 | Component diagram | 02-analysis/structural-views/components.md |
| C4 | Code-level detail | 03-dossiers/code-level-detail.md |
| ADR | ADR navigation index | 01-summary/adr-index.md |
| ADR | Active decision log | 02-analysis/architecture-decisions/ADR-001.md |
| ADR | Superseded/deprecated/rejected decisions | 03-dossiers/adr-superseded.md |
| arc42 | Quality tree / Canvas | 01-summary/quality-tree.md |
| arc42 | Goals, constraints, strategy | 02-analysis/constraints-and-context.md |
| arc42 | Risks, deployment, glossary | 03-dossiers/arc42-supplemental.md |
